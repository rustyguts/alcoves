...
<div class="relative h-6 border-t bg-muted" data-testid="markers-track">
	<span
		class="pointer-events-none absolute top-1 left-1 z-10 rounded bg-muted/80 px-1 text-[9px] font-medium tracking-wide text-muted-foreground uppercase"
	>
		Markers
	</span>
	{#each markers as m (m.id)}
		<button
			type="button"
			class="absolute top-0.5 bottom-0.5 w-1.5 rounded-sm transition-opacity hover:opacity-80 focus-visible:ring-2 focus-visible:ring-primary"
