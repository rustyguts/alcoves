...
>
	{#snippet children({ thumbItems })}
		<span
			...
			class={cn(
				'relative grow overflow-hidden rounded-full bg-muted bg-muted data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5'
			)}
		>
