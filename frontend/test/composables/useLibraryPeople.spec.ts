...
describe("useLibraryPeople", () => {
  ...
  it("setPersonCover updates people and active person state", async () => {
    ...
    expect(mockApiFetch).toHaveBeenCalledWith("/api/libraries/lib-1/people/person-1", {
      method: "PATCH",
  ...
  it("splitFaceAsNewPerson refreshes people and active person faces", async () => {
    ...
    expect(mockApiFetch).toHaveBeenNthCalledWith(2, "/api/libraries/lib-1/people");
    expect(mockApiFetch).toHaveBeenNthCalledWith(3, "/api/libraries/lib-1/people/person-1/faces");
