...
// [w, h, ISO date]; a few flagged as video.
const SPEC: Array<[number, number, string, boolean?]> = [
  // Wed, Jan 14 2026 — busy day, mixed orientations
  [4000, 3000, "2026-01-14T18:10:00Z"],
  [2000, 3000, "2026-01-14T17:55:00Z"],
  [1920, 1080, "2026-01-14T17:40:00Z", true],
  ...
  [1080, 1080, "2026-01-11T10:15:00Z", true],
  ...
  [1280, 720, "2025-12-23T19:30:00Z", true],
...
function buildEntries() {
  return SPEC.map(([width, height, capturedAt, video], i) => {
    const id = `tl-${i}`;
    return {
      id,
