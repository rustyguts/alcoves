...
const STOPWORDS = new Set([
	...
	"with", "by", "from", "up", "down", "out", "as", "if", "so", "than", "then",
	"is", "am", "are", "was", "were", "be", "been", "being", "do", "does", "did",
	"doing", "have", "has", "had", "having", "will", "would", "could", "should",
	"shall", "may", "might", "can", "must", "i", "you", "he", "she", "it", "we",
	"they", "me", "him", "her", "us", "them", "my", "your", "yours", "his", "its",
	"our", "ours", "their", "theirs", "myself", "yourself", "himself", "herself",
	"itself", "ourselves", "themselves", "this", "that", "these", "those", "what",
	"which", "who", "whom", "whose", "when", "where", "why", "how", "not", "no",
	"yes", "yeah", "yep", "nope", "ok", "okay", "um", "uh", "oh", "ah", "hmm",
	"mm", "er", "like", "just", "really", "very", "so", "such", "too", "also",
	"there", "here", "all", "any", "some", "most", "more", "less", "few", "many",
	"much", "lot", "lots", "every", "each", "other", "another", "same", "own",
	"about", "into", "onto", "over", "under", "after", "before", "between",
	"through", "during", "above", "below", "again", "further", "still", "ever",
	"never", "always", "sometimes", "often", "now", "soon", "later", "going",
	"gonna", "wanna", "gotta", "got", "get", "go", "going",
]);
...
<template>
	<div v-if="cues.length > 0" class="rounded-lg border border-default bg-default">
		...
		<div v-if="!collapsed" class="flex flex-col">
			<div
				class="flex items-center gap-1 px-3 pt-2 border-b border-default"
				@click.stop
			>
				<button
					type="button"
			...
			<div v-else class="flex flex-col">
				...
				>
					...
					>
						...
						>
							<span class="text-[11px] text-muted tabular-nums shrink-0 w-6">
								{{ idx + 1 }}.
							</span>
