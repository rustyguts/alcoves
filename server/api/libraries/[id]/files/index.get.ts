import { eq, and, isNull, isNotNull, sql, inArray, asc, count, or } from "drizzle-orm";
import { db, schema } from "~~/server/database";
import { getFolderBreadcrumbs, normalizeFolderId } from "~~/server/utils/folders";
import type { LibraryTag, PaginatedFiles } from "~~/server/utils/types";
