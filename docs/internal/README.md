...
| [`mcp-oauth21-plan.md`](mcp-oauth21-plan.md) | Implementation plan: OAuth 2.1 authorization-server for MCP connections | Maintainer-facing design/sequencing for unshipped work |
